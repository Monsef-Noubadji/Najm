...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Najm","description":"A compiler-first reactive framework with signals, SSR, and zero-JavaScript-by-default islands.","base":"/Najm/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"src":"/najm-mark.svg","alt":"Najm"},"nav":[{"text":"Guide","link":"/guide/getting-started"},{"text":"Architecture","link":"/rfcs/"},{"text":"API status","link":"/rfcs/RFC-0018-public-api-stability"}],"sidebar":{"/guide/":[{"text":"Guide","items":[{"text":"Overview","link":"/guide/"},{"text":"Getting started","link":"/guide/getting-started"},{"text":"Components","link":"/guide/components"},{"text":"Routing and SSR","link":"/guide/routing-and-ssr"},{"text":"CLI","link":"/guide/cli"}]}],"/rfcs/":[{"text":"Architecture record","items":[{"text":"RFC index","link":"/rfcs/"}]}]},"search":{"provider":"local"},"socialLinks":[{"icon":"github","link":"https://github.com/Monsef-Noubadji/Najm"}],"editLink":{"pattern":"https://github.com/Monsef-Noubadji/Najm/edit/main/docs/:path","text":"Edit this page on GitHub"},"outline":{"level":[2,3],"label":"On this page"},"lastUpdated":{"text":"Last updated"},"footer":{"message":"Released under the MIT License.","copyright":"Copyright © 2026 Monsef Noubadji and Najm contributors"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BXkn94kK.js"));
