...
Najm requires Node.js 20 or newer. It is beta software: validate framework upgrades in a staging environment and read [Beta status](./beta-status) before adopting it for a critical system.
