...
Najm requires Node.js 20 or newer. Version `1.0.0-rc.0` is API-frozen while the release evidence is completed; read [Release status](./release-status) before adopting it for a critical system.
